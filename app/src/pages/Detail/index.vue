          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="spuSaleAttr in spuSaleAttrList" :key="spuSaleAttr.id">
                ...
                <dd v-for="attrValue in spuSaleAttr.spuSaleAttrValueList" :key="attrValue.id" changepirce="0" :class="{active:attrValue.isChecked == 1}">{{attrValue.saleAttrValueName}}</dd>
              </dl>
            </div>
            <div class="cartWrap">
              <div class="controls">
